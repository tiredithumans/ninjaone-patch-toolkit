...
- Commit the bump: `git commit -m "chore(release): v<X.Y.Z>"`.
...
`release.yml` creates the release as a **draft** with generated notes and the platform bundles
attached. Review the notes, then publish it from the GitHub UI (or
